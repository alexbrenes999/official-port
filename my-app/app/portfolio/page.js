export default function portfolio(){
    return(
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1">
            ...
            <div className="pr-16 pl-32 py-5">
                {/* <a href="https://alexbrenes999.github.io/code-quiz/">
                <img className="rounded-3xl shadow-xl hover:scale-105 hover:shadow-2xl"
                        src={quiz} alt="code screen"/></a> */}
            </div>
            <div className="pl-16 pr-32 py-5">
                <a href="https://alexbrenes999.github.io/work-day-schedule/">
                    {/* <img className="rounded-3xl shadow-xl hover:scale-105 hover:shadow-2xl"
                        src={schedule} alt="calendar"/>*/}
                </a> 
            </div>
            <div className="pr-16 pl-32 py-5">
                <a href="https://www.google.com">
                    {/* <img className="rounded-3xl shadow-xl hover:scale-105 hover:shadow-2xl"
                        src={hori} alt="businessmen"/>*/}
                </a> 
            </div>
            <div className="pl-16 pr-32 py-5">
                <a href="https://www.google.com">
                    {/* <img className="rounded-3xl shadow-xl hover:scale-105 hover:shadow-2xl"
                        src={threejsdemo} alt="orb"/> */}
                </a>
            </div>
        </div>
